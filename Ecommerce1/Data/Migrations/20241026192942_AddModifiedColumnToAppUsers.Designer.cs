...
namespace Ecommerce1.Data.Migrations
{
    ...
    [Migration("20241026192942_AddModifiedColumnToAppUsers")]
    partial class AddModifiedColumnToAppUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce1.Data.AppUsers", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce1.Data.Order_Details", b =>
                {
                    b.HasOne("Ecommerce1.Data.AppUsers", "AppUsers")
            ...
            modelBuilder.Entity("Ecommerce1.Data.Shopping_Session", b =>
                {
                    b.HasOne("Ecommerce1.Data.AppUsers", "AppUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Ecommerce1.Data.AppUsers", null)
                        .WithMany()
